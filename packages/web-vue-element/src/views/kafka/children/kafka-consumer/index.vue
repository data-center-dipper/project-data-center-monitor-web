  ...
  <div class="container mx-auto p-4">
    ...
    <div class="consumer-list">
      <div
        ...
        :key="index"
        class="consumer-item bg-white p-4 rounded shadow mb-4"
      >
        <div
          class="consumer-header cursor-pointer flex justify-between items-center"
        ...
        >
          ...
          <div>
            <el-button type="text" @click.stop="refresh(consumer)"
              >刷新</el-button
            >
            <el-button type="text" @click.stop="updateConsumer(consumer)"
              >更新</el-button
            >
            <el-button type="text" @click.stop="deleteConsumer(index)"
              >删除</el-button
            >
          </div>
        </div>
        <transition name="fade">
          <div v-if="expandedIndexes[index]" class="consumer-details mt-2">
            ...
            <a
              href="#"
              @click.prevent="collapseDetail(index)"
    ...
    <!-- 新增消费者按钮 -->
    <el-button type="primary" @click="showAddModal" class="add-link"
      >新增</el-button
    >
