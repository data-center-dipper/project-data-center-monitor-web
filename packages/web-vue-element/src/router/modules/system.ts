    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/system/children/route-management/index.vue'),
        meta: {
          keepAlive: true,
          requiresAuth: true,
          title: '路由管理',
      ...
      },
      {
        ...
        component: () =>
          import('@/views/system/children/role-management/index.vue'),
        meta: {
          keepAlive: true,
          requiresAuth: true,
          title: '角色管理',
      ...
      },
      {
        ...
        component: () =>
          import('@/views/system/children/user-management/index.vue'),
        meta: {
          keepAlive: true,
          requiresAuth: true,
          title: '用户管理',
      ...
      },
      {
        ...
        component: () =>
          import('@/views/system/children/department-management/index.vue'),
        meta: {
          keepAlive: true,
          requiresAuth: true,
          title: '部门管理',
