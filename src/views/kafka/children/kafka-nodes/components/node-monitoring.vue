        ...
        <div class="border border-gray-200 rounded-md">
          ...
          <div class="p-3">
            <div class="flex flex-col justify-center py-3 gap-2">
              <span>内存：<span v-settingTextColor="'#ccc'">共8GB</span></span>
              <span>空闲：<span v-settingTextColor="'#ccc'">5.6GB</span></span>
              <span
                >提示:
                <span v-settingTextColor="'#ccc'">内存状态良好</span></span
              >
            </div>
            ...
            <div class="flex flex-col justify-center py-3 gap-3">
              ...
              <span v-settingTextColor="'red'"
                >提示: 数据量太大,即将达到网卡极限</span
              >
            </div>
          </div>
